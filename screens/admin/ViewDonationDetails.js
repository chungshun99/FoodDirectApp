...
const ViewDonationDetails = ({route, navigation}) => {
        ...
        <View style={{padding: 15}}>
          ...
          <View style={{marginTop: 15}}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.rowText}>
                Requested By: {requesterProfile ? requesterProfile.userFirstName : ''} {requesterProfile ? requesterProfile.userLastName : ''}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.rowText}>
                Requester Phone Num: {requesterProfile ? requesterProfile.userPhoneNum : ''}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.rowText}>
                Donation Address: {details ? details.donationAddress : ''}
              </Text>
            </View>
          ...
          <View style={{marginTop: 10}}>
            ...
            <View style={styles.row}>
              <Ionicons name="checkmark-done" color="black" size={22}/> 
              <Text style={styles.rowText}>
