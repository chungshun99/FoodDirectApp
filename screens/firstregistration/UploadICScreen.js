...
const UploadICScreen = ({route, navigation}) => {
  //console.log("UploadICScreen test:", this.props.navigation.state.params.firstname);
  const {user,  userRole} = useContext(AuthContext);
  const { firstname, lastname, address, phonenum, icnumber } = route.params;
    ...
    <ScrollView style={styles.background} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.bottomView}>
        ...
        <View style={{padding: 40}}>
          <Text style={styles.welcomeMessage}>Upload IC Picture</Text>
          <Text style={{fontSize:15, color:"black"}}>Kindly upload a picture of your identification card for verification and safety purposes.</Text>
      ...
      <ImageView
        images={[{uri: image}]}
        //images = {[require('../../images/mintGreen2.jpg')]}
        //images={userICPic}
        imageIndex={0}
        visible={visible}
